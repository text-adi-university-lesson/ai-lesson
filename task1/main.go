...
func main() {
	...
	g.AddEdge(graph.NewEdge(a2, a10, 8))
	...
	g.AddEdge(graph.NewEdge(a15, a16, 1))
	g.AddEdge(graph.NewEdge(a17, a16, 2))
	...
	g.AddEdge(graph.NewEdge(a11, a20, 6))
	g.AddEdge(graph.NewEdge(a12, a20, 3))
	g.AddEdge(graph.NewEdge(a12, a11, 2))
