...
func main() {
	...
	//j := graph.NewNode("J")
	//
	//defaultGraph.AddEdge(graph.NewEdge(a, b, 5))
	//defaultGraph.AddEdge(graph.NewEdge(a, d, 4))
	//defaultGraph.AddEdge(graph.NewEdge(a, e, 1))
	//defaultGraph.AddEdge(graph.NewEdge(b, d, 2))
	//defaultGraph.AddEdge(graph.NewEdge(b, c, 4))
	//defaultGraph.AddEdge(graph.NewEdge(c, h, 4))
	//defaultGraph.AddEdge(graph.NewEdge(c, i, 1))
	//defaultGraph.AddEdge(graph.NewEdge(c, j, 2))
	//defaultGraph.AddEdge(graph.NewEdge(d, e, 2))
	//defaultGraph.AddEdge(graph.NewEdge(d, f, 5))
	//defaultGraph.AddEdge(graph.NewEdge(d, g, 11))
	//defaultGraph.AddEdge(graph.NewEdge(d, h, 2))
	//defaultGraph.AddEdge(graph.NewEdge(e, f, 1))
	//defaultGraph.AddEdge(graph.NewEdge(f, g, 7))
	//defaultGraph.AddEdge(graph.NewEdge(g, h, 1))
	//defaultGraph.AddEdge(graph.NewEdge(g, i, 4))
	//defaultGraph.AddEdge(graph.NewEdge(h, i, 6))
	//defaultGraph.AddEdge(graph.NewEdge(i, j, 0))
